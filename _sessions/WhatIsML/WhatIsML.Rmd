...
```{r, echo = FALSE, fig.align = 'center', out.width = "90%", fig.cap = "<font size = 4>Medium.com</font>"}
...
```{r, echo = FALSE, fig.align = 'center', out.width = "70%", fig.cap= "<font size = 4>amazon.com</font>"}
