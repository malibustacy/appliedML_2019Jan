...
subtitle: ""
=======
title: "Model Fitting (Training)"
subtitle: "With Regression"
>>>>>>> 27cd919559fd68a532814567568b62f3c3feae63
...
The more extreme $\beta_{i}$ is (either positive or negative), the more $X_{i}$ is used to predict the criterion $Y$ 
- But always take into account the scale of $X_{i}$!
...
# Getting final models: .$finalModel
...
This tells us that the Mean Absolute Error (MAE) of the model in fitting was `r round(x[3], 2)`
