...
You can access the model with `mod$finalModel`, you can explore the object with generic functions:
...
Thistells us that the Mean Absolute Error (MAE) of the model in fitting was `r round(x[3], 2)`
