...
<font size = 6> A model is a mathematical representation of data.</font>
...
<font size = 6> A model is a mathematical representation of data.</font> <br><br>
<font size = 6>That can be programmed, and used to understand (and predict) relationships between data</font>
