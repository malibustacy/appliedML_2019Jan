...
3. By comparing the model fits to the true criterion values using a combination of `predict()` and `postResample()` calculate the Mean Absolute Error (MAE) of your new model that uses 4 features. How does this compare to your previous model that only used 1 feature?
