...
2. Conduct a classification analysis predictingn whether or not a school is 'hot' -- where a 'hot' school is one that receives at least 10,000 applications (Hint: use the code below to create the `hot` variable). How good can your regression model predict whether or not a school is 'hot'?
