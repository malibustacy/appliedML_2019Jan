---
title: "Fitting"
subtitle: "Parameter estimation and fitting statistics with regression"
...
competition_raw <- tibble(truth = truth,
                          Regression = glm_fit) %>%
...
ggplot(data = competition_raw, 
  ...
  guides(fill = FALSE) +
  annotate(geom = "label", 
           x = competition_agg$model, 
           y = competition_agg$mae, 
           label = round(competition_agg$mae, 2))
```
...
9. Look at the plot, how do you interpret this? Do you think the model did well or not in fitting graduation rates?
...
2. The nice thing about decision trees is we can visualize them! Visualize your decision tree using the following code. Can you interpret the results?
...
8. Look at the plot, how do you interpret this? Do you find anything strange about the fits of decision trees versus regression? Do you think the model did well or not in fitting graduation rates?
