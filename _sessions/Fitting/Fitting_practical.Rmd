...
```{r, echo = FALSE, fig.align = 'center', eval = FALSE, out.width = "70%", fig.cap="Source: www.niche.com"}
...
2. There is lots of interesting information hidden in each of your model objects which are stored as `X$finalModel` in your fitting objects. Using the following code to get your started, try exploring your randomforest object. What else can you find in it?
