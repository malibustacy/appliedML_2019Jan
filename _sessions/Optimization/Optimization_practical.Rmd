...
3. Plot your `salary_ridge` object. What do you see? Which value of the regularization parameter seems to be the best?
...
3. Plot your `price_lasso` object. What do you see? Which value of the regularization parameter seems to be the best?
...
3. Plot your `price_dt` object. What do you see? Which value of the regularization parameter seems to be the best?
...
3. Plot your `salary_rf` object. What do you see? Which value of the regularization parameter seems to be the best?
