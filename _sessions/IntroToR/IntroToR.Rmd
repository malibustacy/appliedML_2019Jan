...
<div class="center_text">
  <span>
  The 2<sup>4</sup> R Basics for Machine Learning
  </span>
</div> 
...
2. <high>`<-` creates/changes objects</high>
3. Everything happens through functions
4. Functions have (default) arguments
5. View help files using `?`
6. 3 object types
...
3. Everything happens through functions
4. Functions have (default) arguments
5. <high>View help files using `?`</high>
6. 3 object types
7. Data lives in data frames
8. 4 data types
9. Use RStudio and projects
